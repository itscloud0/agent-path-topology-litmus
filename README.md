...
- Codex CLI 0.144.5: `codex debug prompt-input` ran successfully inside a submodule, saw the submodule rule, and did not see the superproject rule. This is reported as an observed client failure, not a fixture failure.
